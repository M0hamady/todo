...
urlpatterns = [
    ...
    path('clalnder-try/',index_cal,name="show_firebase_js"),
    ...
    path('task/<int:id>/', TaskDetailView_calendar.as_view(), name='task_detail_calendar'),
    ...
    # path('calendar/<int:year>/<int:month>/<int:day>/', calendar, name='calendar_day'),
